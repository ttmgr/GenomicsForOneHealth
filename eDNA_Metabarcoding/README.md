...
> **Pipeline Selector:** For routing across the full GenomicsForOneHealth collection before committing to an eDNA workflow, use the public [Pipeline Selector](https://ttmgr.github.io/GenomicsForOneHealth/).
