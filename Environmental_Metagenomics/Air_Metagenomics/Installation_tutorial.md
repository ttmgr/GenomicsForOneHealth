...
**Important:** For the general installation of **Mamba**, **Dorado/Guppy basecallers**, and large databases like **Kraken2** or **AMRFinderPlus**, please see the centralized [INSTALL_AND_DATABASES.md](../../INSTALL_AND_DATABASES.md) at the root of the repository.
