#!/bin/bash
#SBATCH --job-name=integronfinder_array
#SBATCH --output=/home/haicu/ttreska57/logs/integronfinder_%A_%a.out
#SBATCH --error=/home/haicu/ttreska57/logs/integronfinder_%A_%a.err
#SBATCH -p cpu_p
#SBATCH -q cpu_normal
#SBATCH --mem=100G
#SBATCH -t 12:00:00
...
OUTDIR="${BASEDIR}/integronfinder_results/${SAMPLE}"
...
echo "Running IntegronFinder on $SAMPLE..."
integron_finder \
  "$FASTA" \
  --local-max \
  --func-annot \
...
echo "IntegronFinder output files for $SAMPLE:"
