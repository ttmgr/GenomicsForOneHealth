...
> **Installation:** For setup of **Mamba**, **Dorado**, and large databases like **Kraken2**, please see the centralized [INSTALL_AND_DATABASES.md](../../INSTALL_AND_DATABASES.md) at the root of the repository.
